...
CREATE TABLE dbo.Slip_Detail(
	...
	FOREIGN KEY (SlipID) REFERENCES dbo.Slips(SlipID) 	ON UPDATE CASCADE
	ON DELETE CASCADE
);
...
VALUES 
('Nguyen Khanh','92 Quang Trung - Da Nang','0905157600'),
('Nguyen Minh Quoc','92 Quang Trung - Da Nang','0905215457'),
('Ho Phuoc Thoi','92 Quang Trung - Da Nang','0935204877'),
('Nguyen Van Dinh','92 Quang Trung - Da Nang','0935157034'),
('Nguyen Van Hai','92 Quang Trung - Da Nang','0511810583'),
('Nguyen Thi Thu Ha','92 Quang Trung - Da Nang','0511840583'),
('Do Thi Thien Ngan','92 Quang Trung - Da Nang','0511860583'),
